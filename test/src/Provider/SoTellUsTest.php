...
namespace SoTellUs\OAuth2\Client\Test\Provider;

use League\OAuth2\Client\Tool\QueryBuilderTrait;
use Mockery as m;

class SoTellUsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \SoTellUs\OAuth2\Client\Provider\SoTellUs([
    ...
    {
        $this->assertEquals('https://api.sotellus.com', $this->provider->getHost());
    }
