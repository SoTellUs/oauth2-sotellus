...
namespace SoTellUs\OAuth2\Client\Provider;
...
class SoTellUs extends AbstractProvider
{
    use ArrayAccessorTrait,
        BearerAuthorizationTrait;

    /**
     * SoTellUs environment specific host; defaults to api
     *
     * @var string
     */
    protected $host = 'https://api.sotellus.com';
    ...
    protected function checkResponse(ResponseInterface $response, $data)
    {
        ...
        // by SoTellUs were not very well documented. This method will need some
     ...
     * @param AccessToken $token
     * @return SoTellUsResourceOwner
     */
    protected function createResourceOwner(array $response, AccessToken $token)
    {
        return new SoTellUsResourceOwner($response);
    }
}
